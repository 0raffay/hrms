    ...
    <main>
        ...
        <div class="screen-2">
            <div class=" screen">
                <div class="screen-2Form w-100">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6">
                                <div class="screen-1DataForm">
                                    <div class="formContainer">
                                        <h1 class="text-white fc-white">Form2 </h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="switchingScreen switchingScreen1">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6">
                                <div class="screenText screen-2Text pt-md-5 mt-md-5 fc-white">
                                    <h4 class="fs-40 fw-700 lh-1-2 mb-30 w-75">With ResourcePad HR, you will be able to:</h4>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6">
